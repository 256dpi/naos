// Generated by gen_tzdata.py — do not edit by hand.
// Source: IANA tzdata 2025c

#include "tzdata.h"

const size_t naos_tzdata_count = 536;

const naos_tzdata_entry_t naos_tzdata[] = {
    {"Africa/Abidjan", "GMT0"},
    {"Africa/Accra", "GMT0"},
    ...
    {"Africa/Douala", "WAT-1"},
    {"Africa/El_Aaiun", "XXX-2<+01>-1,0/0,J365/23"},
