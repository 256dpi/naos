...
update_naos_tree:
	...
	cd components/esp-mqtt; git fetch; git checkout v0.5.0; git submodule update --recursive; cd ../..
	cd components/naos-esp; git fetch; git checkout v0.1.4; git submodule update --recursive; cd ../..
