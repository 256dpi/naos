...
update_naos_tree:
	...
	cd components/esp-mqtt; git fetch; git checkout v0.4.3; git submodule update --recursive; cd ../..
	cd components/naos-esp; git fetch; git checkout v0.1.1; git submodule update --recursive; cd ../..
